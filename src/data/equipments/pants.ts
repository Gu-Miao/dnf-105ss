...
export const pants: Data[] = [
  ...
  },
  {
    name: '恩特精灵护腿',
    type: '下装',
    attackEnhancement: 593 + 1186 + 1186 + 1186,
    abnormal: {
      type: '出血',
      prevConversionRate: 0.5,
      prevAbnormalDamageEnhancement: 0.2,
  ...
  },
  {
    name: '恩特精灵护腿',
    type: '下装',
    attackEnhancement: 593 + 1186 + 178 * 10 + 1186 + 1630,
  ...
  },
  {
    ...
    type: '下装',
    skillAttacks: [20 * 0.3],
    attackEnhancement: 1186 + 1186 + 1186 + 1630,
    elementEnhancement: 15 + 15,
    coldDownReduce: 0.2 * 0.3,
    other: 'Lv80 技攻，Lv80 冷却，15 单，15 全，按鹦鹉双 80 上衣剜心 30% 占比计算',
  },
]
