import {
  ...
  ELEMENTAL_DAMAGE,
  DAMAGE_VALUE_FUSION_COMPARATION,
  BURN_BREAK_ICE_RATE,
} from '@/constants'
...
function Header() {
  return (
    <header>
      ...
      <p>更新至国服幽暗岛版本。</p>
      <p>
        所有装备攻强取 1 级，攻强分母 {DAMAGE_VALUE_EQUIPMENT_COMPARATION}，属强 {ELEMENTAL_DAMAGE}
        。计算贴膜时的模板攻强为 {DAMAGE_VALUE_FUSION_COMPARATION}
        ，老贴膜都为升神后。CD 提升率估算方式为 1% 技攻 = 2% 冷却减少 = 3%
